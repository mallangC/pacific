    ...
    <div>
      ...
      <div className="bg-gray-50 border-b border-gray-100 py-8 md:py-12 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-2xl md:text-3xl font-light text-gray-900">대표 인사말</h1>
        </div>
      </div>
      ...
      <div className="py-10 md:py-16 px-6">
        <div className="max-w-2xl mx-auto">
          ...
          {/* 인사 */}
          <p className="text-base text-gray-700 font-medium mb-6 md:mb-10">
          ...
          <div className="space-y-6 text-sm text-gray-600 leading-[1.9]">
            ...
            <div className="border-l-2 border-gray-200 pl-6 py-1 my-8 space-y-4">
          ...
          <div className="mt-10 md:mt-14 pt-8 border-t border-gray-100 text-right space-y-1">
            ...
            <p className="text-sm text-gray-700 font-medium">태평양투자그룹 대표 드림</p>
          </div>
